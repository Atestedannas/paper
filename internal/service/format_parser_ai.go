...
// PaperSegmentFormatHint 与 PaperSectionSegment 按下标一一对应，供 WordZero 等写段前设置 TextFormat/Spacing。
...
// ParseTemplateSegmentFormatsAI 根据模板论文全文 + 学生稿 segments 顺序，请求 DeepSeek 返回与 segments 一一对齐的版式（供 WordZero 写段）。
